            ...
            <section className="mt-7 grid gap-7 lg:grid-cols-[minmax(0,1fr)_minmax(0,0.9fr)]">
              <div className="rounded-[2rem] border border-border bg-card p-6 shadow-sm sm:p-8">
                ...
                <div className="mt-6 grid gap-3 sm:grid-cols-2">
                  ...
                  <Feature>Video tour request</Feature>
                </div>
              </div>
          ...
          <aside className="lg:sticky lg:top-24 lg:h-fit">
            <div className="rounded-[2rem] border border-border bg-card p-5 shadow-xl">
              ...
              <div className="mt-5 grid grid-cols-2 gap-3">
                ...
                <MiniAction href={`/tours?propertyId=${property.id}&mode=video`} icon={Video} label="Video Tour" note="Zoom ready" />
              </div>
              ...
              <div className="mt-5 rounded-2xl border border-border bg-background p-4">
                ...
                <p className="mt-2 text-sm leading-6 text-muted-foreground">
                  Member questions, tour requests, documents, and video calls are kept close to the property page.
                </p>
              </div>
            </div>
          </aside>
